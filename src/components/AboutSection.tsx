			...
			<div className="container mx-auto max-w-6xl">
				<div className="text-center mb-16">
					...
					<p className="text-lg text-foreground/70 max-w-2xl mx-auto">
						Избавляем людей от утомительных поисков, освобождая время
						на что-то более важное с помощью функциональных,
						персонализированных решений для организации пространства в сумках.
					</p>
				</div>
